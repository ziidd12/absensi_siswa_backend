...
<body>
    ...
    <div class="sidebar">
        ...
        <nav class="sidebar-menu">
            ...
            <a href="{{ route('penilaian-siswa.index') }}" class="nav-item-custom {{ request()->routeIs('penilaian-siswa.*') ? 'active' : '' }}">
            ...
            <a href="{{ route('laporan-penilaian.index') }}" class="nav-item-custom {{ request()->routeIs('laporan-penilaian.*') ? 'active' : '' }}">
